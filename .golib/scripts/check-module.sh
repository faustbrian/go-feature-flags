...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-feature-flags" &&
                "${module_path}" != github.com/faustbrian/go-feature-flags/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-feature-flags"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
